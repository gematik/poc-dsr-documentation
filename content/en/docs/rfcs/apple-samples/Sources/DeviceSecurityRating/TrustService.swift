...
public protocol TrustService {
    ...
    /// - Returns: A device token to prove attestestation of this device, throws otherwise
    func requestAttestation() async throws -> DeviceToken

    /// Reset attestation
    func resetAttestation() async throws

    /// Retrieve a list of all registred devices for the user.
...
public class DefaultTrustService: TrustService {
    ...
    public func registration() async throws -> MTLSCert {
        ...
        let csrContent = [
            CSRHelper.OID.countryName: "EN",
            .stateOrProvinceName: "none",
            .localityName: "none",
            .organizationName: "Wikipedia",
